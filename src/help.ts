  ...
  const pages = [
    new discord.Message()
      .addComponents([
        ...
        new discord.Component().setId('now', userId).setLabel('/now'),
      ...
      new discord.Embed()
        ...
        .setDescription(
          [
            ...
            '',
            i18n.get('help-page4-cooldown', locale, STEAL_COOLDOWN_HOURS / 24),
            '',
      ...
      new discord.Embed()
        ...
        .setDescription(
          [
            ...
            `- \`/search\` \`/anime\` \`/manga\` \`/series\`: _${i18n.get(
              '/search',
              locale
            )}_`,
            ...
            '',
            `- \`/party view\` \`/team view\` \`/p view\`: _${i18n.get(
              '/party view',
              locale
            )}_`,
            `- \`/party assign\` \`/team assign\` \`/p assign\`: _${i18n.get(
              '/party assign',
              locale
            )}_`,
            `- \`/party swap\` \`/team swap\` \`/p swap\`: _${i18n.get(
              '/party swap',
              locale
            )}_`,
            `- \`/party remove\` \`/team remove\` \`/p remove\`: _${i18n.get(
              '/party remove',
              locale
            )}_`,
            `- \`/party clear\` \`/team clear\` \`/p clear\`: _${i18n.get(
              '/party clear',
              locale
            )}_`,
            '',
            `- \`/collection show\` \`/coll show\` \`/mm show\`: _${i18n.get(
              '/coll show',
              locale
            )}_`,
            `- \`/collection stars\` \`/coll stars\` \`/mm stars\`: _${i18n.get(
              '/coll stars',
              locale
            )}_`,
            `- \`/collection media\` \`/coll media\` \`/mm media\`: _${i18n.get(
              '/coll media',
              locale
            )}_`,
            `- \`/collection sum\` \`/coll sum\` \`/mm sum\`: _${i18n.get(
              '/coll sum',
              locale
            )}_`,
            '',
      ...
      new discord.Embed()
        ...
        .setDescription(
          [
            ...
            '',
            `- \`/buy normal\` \`/shop normal\`: _${i18n.get(
              '/buy normal',
              locale
            )}_`,
            `- \`/buy guaranteed\` \`/shop guaranteed\`: _${i18n.get(
              '/buy guaranteed',
              locale
            )}_`,
            '',
